...
for(var i=0, end=allWaypointsArray.length;
    i<end;
    i++)allWaypointsArray[i][method]()
}
,
...
this.oldScroll= {
    x: axes.horizontal.newScroll, y:axes.vertical.newScroll
}
}
,
...
for(var i=0, end=allWaypoints.length;
    i<end;
    i++)allWaypoints[i].destroy()
}
,
...
axes= {
horizontal: {
    contextOffset: isWindow?0:contextOffset.left, contextScroll:isWindow?0:this.oldScroll.x, contextDimension:this.innerWidth(), oldScroll:this.oldScroll.x, forward:"right", backward:"left", offsetProp:"left"
}
,
vertical: {
    contextOffset: isWindow?0:contextOffset.top, contextScroll:isWindow?0:this.oldScroll.y, contextDimension:this.innerHeight(), oldScroll:this.oldScroll.y, forward:"down", backward:"up", offsetProp:"top"
}
}
;
for(var axisKey in axes) {
...
for(var i=0, end=waypoints.length;
    i<end;
i+=1) {
...
Waypoint.adapters.push( {
    name: "jquery", Adapter:JQueryAdapter
}
),
...
, arguments[1]), overrides.handler=arguments[0]),
this.each(function() {
